"""
Django settings for plcdata project.
...
SECRET_KEY = 'django-insecure-2^2-f7%^gcd=-irk1@ycafwkl6jr4(5$i&2n3ul-pn)w3ciw&g'
...
WSGI_APPLICATION = 'plcdata.wsgi.application'
